...
// To clear a timeout, you can use the clearTimeout() method passing in the identifier returned by setTimeOut, as parameter to the clearTimeout(<here>). 

// A more practical scenario is clearing timeouts when the component is unmounting to free up the resource and also prevent code from incorrectly executing on an unmounted component.
...
// Logs 'Hello Bruce Wayne' to the console after 2 seconds
...
clearInterval(timeoutId) // Nothing is logged to the console because setTimeOut is cleared before it can get out from task Queue for executing.
