...
//--------------------------------------------------------------------
// -> Execution happens at the time of binding.
// -> Takes object as its 1st arg to which 'this' keyword will refer to, then as 2nd arg it takes an array inside which we can pass our n number of args separated by comma, to be recieved by the funcion as parameter.
// -> It returns and calls the same function at the time of binding.
...
//--------------------------------------------------------------------
// -> Execution happens at the time when we execute/invoke the returned function.
